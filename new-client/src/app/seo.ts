const SITE_URL = typeof window === 'undefined' ? 'https://anushkasinghal24.github.io' : window.location.origin
const DEFAULT_IMAGE = `${SITE_URL}/myicon.png`
...
export function applySeo(payload: SeoPayload) {
  ...
  upsertMetaByName('keywords', payload.keywords ?? 'Anushka Singhal, Full Stack Developer, React.js Developer, Portfolio')
