...
export function CapabilityMatrixSection({ sectionId = 'skills' }: CapabilityMatrixSectionProps) {
  ...
  return (
    <SectionWrapper
      ...
      eyebrow="Skills"
      title="Skills"
      description="Programming, framework, database, tools, and certifications overview."
